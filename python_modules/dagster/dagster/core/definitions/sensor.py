...
class SensorDefinition:
    ...
    Args:
        ...
        jobs (Optional[Sequence[GraphDefinition, JobDefinition]]): A list of jobs to execute when this sensor fires.
    """
...
class AssetSensorDefinition(SensorDefinition):
    ...
    Args:
        ...
        jobs (Optional[Sequence[Union[GraphDefinition, JobDefinition]]]): A list of jobs to be executed when the sensor fires.
